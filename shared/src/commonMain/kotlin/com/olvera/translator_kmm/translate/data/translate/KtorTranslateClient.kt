package com.olvera.translator_kmm.translate.data.translate

import com.olvera.translator_kmm.NetworkConstants
...
import com.olvera.translator_kmm.translate.domain.translate.TranslateException
            ...
            httpClient.post {
                ...
                setBody(
                    TranslateDto(
                        ...
                        targetLanguageCode = toLanguage.langName
                    )
                )
            }
        } catch (e: IOException) {
